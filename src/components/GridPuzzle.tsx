  ...
  return (
    <div className="min-h-screen bg-neutral-50 fixed w-full">
      ...
      <div className="flex flex-col items-center pt-[45px] relative">
        ...
        <div className="fixed bottom-[5px] left-0 right-0 flex flex-col items-center gap-2 pb-12 z-20">
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription className="text-left space-y-2">
                ...
                <p>• stvori svoju kompoziciju povlačenjem odabrane pločice na odabrano mjesto ili dvostrukim klikom na pločicu popuni prvo prazno mjesto</p>
