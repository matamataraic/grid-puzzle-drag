  ...
  return (
    <div className="min-h-screen bg-neutral-50 fixed w-full">
      ...
      <div className="flex flex-col items-center pt-[45px] relative">
        <div className="flex items-center gap-50 fixed top-[45px] z-20">
    ...
    borderColor: 'white'  // Sets the outer border color to white
        ...
        <div className="fixed bottom-0 left-0 right-0 flex flex-col items-center gap-25 pb-4 z-20">
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={handleClear}
          ...
          <div className="flex items-center gap- 55 mt-5">
